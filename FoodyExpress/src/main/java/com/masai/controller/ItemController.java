...
public class ItemController {
	...
	@GetMapping("/view")
	public ResponseEntity<Item> viewItemHandler(@RequestBody Item item){
		
		Item existedItem = itemService.viewItem(item);
	...
	public ResponseEntity<Item> removeItemHandler(@RequestBody Item item){
	...
	public ResponseEntity<List<Item>> viewAllItemsOfRestaurantHandler(@RequestBody Restaurant restaurant){
		
		List<Item> listItem = itemService.viewAllItemsOfRetaurant(restaurant);
